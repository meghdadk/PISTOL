...
def main(cfg):
    ...
    whole_forget_edge = cfg.forget_edge
    # start the seq loop here:
    for seq_num in range(len(cfg.forget_edge)):
        cfg.forget_edge = whole_forget_edge[seq_num]
        print(f"forget_edge: {cfg.forget_edge}")
        #load data
